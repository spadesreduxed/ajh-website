(function () {
  ...
  function date(day) { return day === 94 ? 'Jul 28, 2026' : day === 93 ? 'Jul 27, 2026' : day === 92 ? 'Jul 26, 2026' : new Date(2026, 3, 21 + day).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }); }
