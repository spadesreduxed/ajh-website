(function () {
  ...
  function date(day) { return day === 97 ? 'Jul 31, 2026' : day === 96 ? 'Jul 30, 2026' : day === 95 ? 'Jul 29, 2026' : day === 94 ? 'Jul 28, 2026' : day === 93 ? 'Jul 27, 2026' : day === 92 ? 'Jul 26, 2026' : new Date(2026, 3, 21 + day).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }); }
