(function () {
  ...
  function render() {
    [['title','title'],['owner','owner'],['scope','scope'],['behavior','behavior'],['quality','quality'],['record','notes']].forEach(([field,id]) => { const el = $('proof-' + id); if (el && document.activeElement !== el) el.value = state[field] || ''; });
