(function () {
  ...
  function date(day) { const dates = { 109: 'Aug 12, 2026', 108: 'Aug 11, 2026', 107: 'Aug 10, 2026' }; return dates[day] || new Date(2026, 3, 21 + day + 4).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }); }
