...
- Added recalculation, browser-local exploration persistence, hero shortcut, navigation link, and `Shift P` keyboard access.
...
## Previous Build - Day 89 (2026-07-21)
...
- Kept the history private and browser-local; no audit data leaves the page.
